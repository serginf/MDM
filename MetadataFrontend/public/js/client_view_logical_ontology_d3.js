...
$(window).load(function() {
    ...
    d3.json('/artifacts/LOGICAL_ONTOLOGY/'+encodeURIComponent(getParameterByName('graph'))+'/graphical', function (error, graph) {

        var width = $(window).width()*0.75;
        var height = $(window).height()*0.5;
        var nodeRadius = 10;

        outer = d3.select("#logicalOntologyWrapper").append("svg")
            .attr("width", width)
            .attr("height", height)
